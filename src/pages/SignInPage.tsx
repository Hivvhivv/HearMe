...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // WAJIB:
      // loading kembali false walaupun login gagal
      setLoading(false);
    }
  };
      ...
      <div className="flex items-center justify-center py-16 px-4">
        <div className="w-full max-w-md animate-scale-in">
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-purple-100 border border-purple-50 p-8">
            ...
            >
              ...
              <div>
                ...
                <div className="text-right mt-1">
                  <button
                    type="button"
                    className="text-xs text-[#6F3FB5] hover:underline"
                  >
                    Forgot Password?
                  </button>
                </div>
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 border border-purple-100 hover:bg-[#FAF8FD] py-3 rounded-xl text-sm font-medium text-gray-700 transition-colors"
            >
              <svg
                width="18"
                height="18"
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link
                to="/choose-role"
                className="text-[#6F3FB5] font-semibold hover:underline"
              >
                Create Account
              </Link>
            </p>
