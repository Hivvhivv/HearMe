...
export default function DashboardPage() {
  ...
  const [showMoodModal, setShowMoodModal] =
    useState(false);
  ...
  const [reflectionSent, setReflectionSent] =
    useState(false);
              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    ${
                      isToday
                        ? "bg-[#F5EEFC] border-2 border-[#C9A9E9]"
                        : "bg-[#FAF8FD] border border-purple-50"
                    }
                  `}
                >
            ...
            {psychologists
              ...
              .map((p) => (
                ...
                <Link
                  ...
                  className="group bg-white rounded-2xl p-4 border border-purple-50 hover:border-purple-200 hover:shadow-lg transition-all"
                >
        ...
        <section className="bg-gradient-to-br from-[#F5EEFC] to-white rounded-3xl p-6 border border-purple-100">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex-1">
              ...
              <Link
                to="/journal"
                className="inline-flex items-center gap-2 bg-[#6F3FB5] hover:bg-purple-800 text-white font-semibold px-5 py-2.5 rounded-xl text-sm transition-colors shadow-sm shadow-purple-200"
              >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            {[
...

              {
                ...
                img: "https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=400&h=200&fit=crop&auto=format",
                color:
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {articles.map((a) => (
              ...
              <Link
                key={a.id}
                to={`/article/${a.id}`}
                className="group bg-white rounded-2xl overflow-hidden border border-purple-50 hover:border-purple-200 hover:shadow-lg transition-all"
              >
